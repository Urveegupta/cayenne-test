...
/**
 * Class _CurrentDeptEmp was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _CurrentDeptEmp extends BaseDataObject {

    private static final long serialVersionUID = 1L; 


    public static final Property<String> DEPT_NO = Property.create("deptNo", String.class);
    ...
    public void setDeptNo(String deptNo) {
        beforePropertyWrite("deptNo", this.deptNo, deptNo);
        this.deptNo = deptNo;
    }

    public String getDeptNo() {
        beforePropertyRead("deptNo");
        return this.deptNo;
    }
    ...
    protected void readState(ObjectInputStream in) throws IOException, ClassNotFoundException {
        super.readState(in);
        this.deptNo = (String)in.readObject();
